...
// Each tier cell's [0] text is the map count. The search bar belongs to the stash panel.
public sealed class MapStashUi
{
    ...
    // True when the grid holds maps of that tier, by base name, ignoring the search filter.
