...
// Reflection model of the settings tree, built from the [Menu] attributes. Attribute
// values are read as constructor arguments, so this compiles against builds that rename
// the attribute's members.
